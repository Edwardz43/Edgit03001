...
/*
 * 陽春版的檔案總管 
 * 有開啟文字檔  儲存檔案 離開三種基本功能
 */
public class TextBook2 extends JFrame{
	//按鈕
	...
	public TextBook2(){
		...
		ta.setLineWrap(true);
		//設定顯示的字體  字型大小
		ta.setFont(new Font("微軟正黑體", Font.PLAIN, 16));
		//設定是窗大小  可見  關閉
		setSize(640, 480);
		setVisible(true);
	...
	private void openFile() {
	    ...
	    if(option == JFileChooser.APPROVE_OPTION) {
	        try {
	            ...
	            //和上課時不同的  TextArea要多加一個line separator來讀取換形符號 然後輸出到textarea 不然無法換行
